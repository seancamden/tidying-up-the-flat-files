...
date: 2010-04-11T21:47:14+00:00
author: seancamden
layout: revision
guid: http://seancamden.com/2010/04/11/64-revision-23/
permalink: /?p=87
---
Good design is good design. And skills developed designing for print are transferable to Web. But the tools are different, the limitations are different, and so are the possibilities. You won&#8217;t have to worry about [widows and orphans](http://en.wikipedia.org/wiki/Widows_and_orphans) so much. Your font choices are a lot fewer. Instead of leading and [tracking](http://en.wikipedia.org/wiki/Kerning) you now have line-height and line-spacing (kerning isn&#8217;t adjustable with CSS). 
